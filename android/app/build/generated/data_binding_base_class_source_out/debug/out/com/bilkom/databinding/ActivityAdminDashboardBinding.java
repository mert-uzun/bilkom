...
public final class ActivityAdminDashboardBinding implements ViewBinding {
  ...
  @NonNull
  public final Button btnClubApprovals;

  @NonNull
  public final Button btnUserList;

  private ActivityAdminDashboardBinding(@NonNull LinearLayout rootView,
      @NonNull Button btnClubApprovals, @NonNull Button btnUserList) {
    this.rootView = rootView;
    this.btnClubApprovals = btnClubApprovals;
  ...
  public static ActivityAdminDashboardBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.btnClubApprovals;
      Button btnClubApprovals = ViewBindings.findChildViewById(rootView, id);
      if (btnClubApprovals == null) {
        break missingId;
      }

      id = R.id.btnUserList;
      Button btnUserList = ViewBindings.findChildViewById(rootView, id);
      if (btnUserList == null) {
        break missingId;
      }

      return new ActivityAdminDashboardBinding((LinearLayout) rootView, btnClubApprovals,
          btnUserList);
    }
